...
<body>
    ...
    <section class="normal-breadcrumb set-bg" data-setbg="img/normal-breadcrumb.jpg">
        <div class="container">
            <div class="row">
                <?php
                $sql_b_type = " SELECT * FROM blog_type WHERE id = " . $_GET['type_id'];
                $result_b_type = mysqli_query($conn, $sql_b_type);
                $rs_b_type = mysqli_fetch_assoc($result_b_type);
                ?>
                <div class="col-lg-12 text-center">
                    <div class="normal__breadcrumb__text">
                        <h2>Boukensha Blog</h2>
                        <p><?= $rs_b_type['blog_type_name'] ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div id="blog-pages">
                <div class="row">
                    ...
                    $strSQL = " SELECT * FROM  blog WHERE blog_type_id = '$type_id' ";
