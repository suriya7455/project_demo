...
<head>
    ...
    <style>
        ...
        .bg-hall {
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('images/bg_anime/bg-hall.jpg') no-repeat top center;
            -webkit-background-size: 100% 100%;
            -moz-background-size: 100% 100%;
            -o-background-size: 100% 100%;
            background-size: 100% 100%;
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="anime__details__text">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="text-center text-light font-weight-bold">Origin Quest</h4>
                                <div class="table-responsive">
                                    <table class="table table-borderless text-light text-nowrap">
                                        <thead>
                                            <tr>
                            ...
                            <div class="col-md-6">
                                <h4 class="text-center text-light font-weight-bold">Boukensha Hall of Fame</h4>
                                <div class="table-responsive">
                                    <table class="table table-borderless text-light text-nowrap">
                                        <thead>
                                            <tr>
    ...
    <!-- Hero Section Begin -->
    <div class="heroHeder-t">
        <h5><a href="condition.php" class="at02">Boukensha Guild:เงือนไขในการให้บริการ</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span><a href="PDPA.php" class="at02">Boukensha Guild: นโยบายคุ้มครองข้อมูลส่วนบุคคล (PDPA)</a></span></h5>
    </div>
    <section class="hero">
        <div class="container">
            ...
            <div class="hero__slider owl-carousel" id="myhero2">
                <?php
                ...
                ?>
                    <div class="hero__items set-bg" data-setbg="images/banner/<?= $rs_banner_slider['banner_image'] ?>" id="showbanner" data-href="<?=$rs_banner_slider['banner_link'] ?>">
                        <div class="row">
                            <div class="col-lg-6">
    ...
    <div class="Homepageicom">
        <div class="lst-menu-icom">
            <a href="quest-add.php">
            <div class="img-div">
            <img src="img/menuicom/01.png">      
            </div>
            <div class="t-icom">ฝากเควส</div>
            </a>
        </div>
        <div class="lst-menu-icom">
            <a href="new-quest.php">
            <div class="img-div">
            <img src="img/menuicom/02.png">            
            </div>
            <div class="t-icom">ตามหาภารกิจ</div>
            </a>
        </div>
        <div class="lst-menu-icom">
            <a href="last-completed-quest.php">
           <div class="img-div">
            <img src="img/menuicom/03.png">
             
            </div>
            <div class="t-icom">ภารกิจที่เสร็จแล้ว</div>
            </a>
        </div>
        <div class="lst-menu-icom">
            <a href="#">
           <div class="img-div">
            <img src="img/menuicom/04.png">
             
            </div>
            <div class="t-icom">จัดตั้งปาร์ตี่</div>
            </a>
        </div>
        <div class="lst-menu-icom">
            <a href="HallofFame.php">
            <div class="img-div">
            <img src="img/menuicom/05.png">    
            </div>
             <div class="t-icom">Hall of Fame</div>
             </a>
        </div>
        <div class="lst-menu-icom">
            <a href="blog.php">
            <div class="img-div">
            <img src="img/menuicom/06.png">          
            </div>
            <div class="t-icom">บทควม</div>
            </a>
        </div>
        <div class="lst-menu-icom">
            <a href="pages.php?id=4">
            <div class="img-div">
            <img src="img/menuicom/07.png">
             
            </div>
            <div class="t-icom">คู่มืออธิบาย</div>
            </a>
        </div>
    </div>
     <section class="hero">
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="lo01">
            <h3 class="Board-01">Group Party</h3>
              <h4 class="text-center text-guild font-weight-bold t4" ><a href="new-quest.php" class="text-guild">New Group</a></h4>
              <div class="from-table">
              <table id="customers">
                <tr class="text-nowrap">
                     <th class="text-center">Team</th>
                     <th class="text-center">Party Descriptions</th>
            ...
            <div class="listallouest">
                <a href="new-quest.php" class="text-guild">ดูรายการกลุ่มทั้งหมด</a>
            </div>
            <div class="col-md-12 mt-5 text-center">
                <a href="quest-add.php" class="btn btn-lg btn-success">จัดตั้งกลุ่มใหม่</a>
            </div>
            </div>
            </div>
        </div>
    ...
    <!-- Guild Board Begin-->
  <!--   <section class="product spad bg-guilboard" style="margin-bottom:0;padding-bottom:0;">
        <div class="container">
            <div class="row py-5 px-5">
                <div class="col-lg-12">
                    <div class="anime__details__text">
                        <div class="anime__details__title">
                            <h2 class="text-center text-dark font-weight-bold">Guild Board</h2>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="text-center text-guild font-weight-bold"><a href="new-quest.php" class="text-guild">New Quest</a></h4>
                                <div class="table-responsive">
                                    <table class="table table-borderless text-dark">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_quest_limit7 = " SELECT * FROM quest WHERE quest_status = 'อยู่ระหว่างตามหานักผจญภัย' OR quest_status = 'นักผจญภัยรับภารกิจ' ORDER BY quest_created DESC LIMIT 0,10";
                                            $result_quest_limit7 = mysqli_query($conn, $sql_quest_limit7);
                                            while ($rs_quest_limit7 = mysqli_fetch_assoc($result_quest_limit7)) {
                                            ?>
                                                <tr>
                                                    <td><a class="text-guild" href="quest-detail.php?id=<?= $rs_quest_limit7['id'] ?>"><?= questnameIndex2($rs_quest_limit7['quest_name']) ?></a></td>
                                                    <td class="text-center"><?= $rs_quest_limit7['quest_assignor'] ?></td>
                                                    <td class="text-center"><?= $rs_quest_limit7['quest_reward'] ?></td>
                                                    <td class="text-center"><?= quest_sta($rs_quest_limit7['quest_status']) ?></td>
                                                </tr>
                            ...
                            <div class="col-md-6">
                                <h4 class="text-center text-danger font-weight-bold"><a href="last-completed-quest.php" class="text-guild">Last Complete Quest</a></h4>
                                <div class="table-responsive">
                                    <table class="table table-borderless text-dark">
                                        <thead>
                                            <tr class="text-nowrap">
                                ...
                                <a href="last-completed-quest.php" class="float-right text-guild">ดูรายการเควสที่แล้วเสร็จทั้งหมด</a>
                            </div>
                            <div class="col-md-12 mt-5 text-center">
                                <a href="quest-add.php" class="btn btn-lg btn-success">มอบหมายภารกิจ</a>
                            </div>
