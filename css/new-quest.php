...
<head>
    ...
    <title>Boukensha Guild | New Quest</title>
...
<body>
                ...
                <div class="col-md-10">
                    <div class="anime__details__text col-9 mx-auto">
                        <div class="anime__details__title">
                            <h2 class="text-center text-dark font-weight-bold">New Quest</h2>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive mb-3">
                                    <table class="table table-borderless text-dark" id="new-quest-grid">
                                        <thead>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4 text-center"><i class="fas fa-door-closed text-primary"></i>&nbsp; <a href="last-completed-quest.php" class="text-danger font-weight-bold">ภารกิจที่แล้วเสร็จ</a></div>
    ...
    <script>
        <?php if (!empty($_GET['search_input'])) {
            $s_input = $_GET['search_input'];
        ?>
            $("#search").val('<?= $s_input ?>');
            $("#search").focus();
        <?php
