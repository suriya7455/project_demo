            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="anime__details__text">
                        ...
                        $sql_ps = "SELECT * FROM pages WHERE id = '$id_pages' ";
                        $result_ps = mysqli_query($conn, $sql_ps);
                        $rs_ps = mysqli_fetch_assoc($result_ps);
                        ?>
                        <div class="anime__details__title">
                            <h2 class="text-center text-white font-weight-bold"><?= $rs_ps['pages_name'] ?>
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="pages__details__text">
                        <?= $rs_ps['pages_content'] ?>
                    </div>
                </div>
            </div>
